//  Q 2.After mentioning to Professor Jackson that you would like to get some more practice with exceptions, she offered to let you write some grading software! Before she gives you full control over auto-grading students’ work, she asked if you could write a function called checkFileExtension(). 
...
public class CheckFileExtension {
	public static void main(String[] args) {
		...
		String []names= { "Ram", "Shiwa", "Mukesh" };
		String []files = { "notes.java", "ram.txt", "", };
		...
		for (String file : files) { // using for loop for string values
			...
			try {
				...
				if (r == 1)// condition check
					...
					System.out.println(
							"Hello " + names[i] + ". Your " + file + " is not a java file. And your score is 0");
