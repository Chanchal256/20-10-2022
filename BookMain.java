...
public class BookMain {
	public static void main(String[] args) {
		...
		arr[0] = new Book(101, "The White Tiger");
		arr[1] = new Book(102, "The God of Small Things");
		arr[2] = new Book(103, "The Guide");
		arr[3] = new Book(104, "The Place of Illusions");
		arr[4] = new Book(105, "Discovery of India");
